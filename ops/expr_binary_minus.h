...
namespace po
{
  ...
  constexpr auto operator-(const E1& expr1, const E2& expr2)
  {
    if constexpr(supported_scalar_type<E2>)
      return expr_binary_minus<const E1&, const expr_constant>{expr1, expr_constant{expr2}};
    else if constexpr(supported_scalar_type<E1>)
      return expr_binary_minus<const expr_constant, const E2&>{expr_constant{expr1}, expr2};
    else
      return expr_binary_minus<const E1&, const E2&>{expr1, expr2};
  }
