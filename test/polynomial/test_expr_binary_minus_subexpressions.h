...
void test_expr_binary_p_minus_c_subexpressions();
void test_expr_binary_p_minus_p_subexpressions();
void test_expr_binary_c_minus_p_subexpressions();

void test_expr_binary_minus_subexpressions()
{
  test_expr_binary_p_minus_c_subexpressions();
  test_expr_binary_p_minus_p_subexpressions();
  test_expr_binary_c_minus_p_subexpressions();
