...
void test_instantiate_Dp_mult_p(const po::polynomial& p, const po::polynomial& q, po::polynomial ex);

void test_instantiate_Dp_mult_p()
{
  {
    ...
    test_instantiate_Dp_mult_p<po::rank<2>>(
      p, q,
      {
        {0, {0, 0}},
      });
