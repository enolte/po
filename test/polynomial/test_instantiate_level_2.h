...
#include "test_instantiate_integral_p_mult_p.h"   // I(x0 +     x0)
#include "test_instantiate_integral_p_plus_p.h"   // I(x0   -   x0)
#include "test_instantiate_integral_p_minus_p.h"  // I(x0     * x0)
...
void test_instantiate_level_2()
{
  ...
  test_instantiate_integral_p_mult_p();           // I(x0 +     x0)
  test_instantiate_integral_p_plus_p();           // I(x0   -   x0)
  test_instantiate_integral_p_minus_p();          // I(x0     * x0)
