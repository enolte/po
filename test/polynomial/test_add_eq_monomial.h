...
{
  {
    ...
    assert(equal(p.variable_degrees, 3, 1, 0));
    ...
    assert(equal(p.variable_degrees, 3, 7, 0));
  }
...

  {
    ...
    assert(p.nterms() == 4);
    assert(p.coefficient(1, 0, 0) == 5);
    assert(equal(p.variable_degrees, 3, 5, 0));
...

  {
    ...
    assert(p.nterms() == 3);
    assert(equal(p.variable_degrees, 8, 5, 4, 4, 0, 3, 4));
    ...
    assert(equal(p.variable_degrees, 8, 5, 4, 4, 0, 4, 4));
