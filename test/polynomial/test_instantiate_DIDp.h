...
//  po::polynomial dp1_2_13 {{8, {1, 0,    1}}}; // I(D(p, 1)) over [1, 3] in place 2
    ...
    const po::polynomial ac = instantiate(D(integral(D(p, 1), {2, {1, 3}}), 1));
...
//  po::polynomial dp1_2_13 {{8, {1, 0,    1}}}; // I(D(p, 1)) over [1, 3] in place 2
    ...
    const po::polynomial ac = instantiate(D(integral(D(p, 1), {2, {1, 3}}), 2));
