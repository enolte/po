...
namespace po_test
{
  namespace rank2_degree1_vandermonde
  {
    void test1();
    void test2();
  }

  void test_vandermonde_rank2_degree1()
  {
    using namespace rank2_degree1_vandermonde;
  ...
  namespace rank2_degree1_vandermonde
  {
    void test1()
    {
      ...
      auto v = po_test::vandermonde::timed_construct(f, 2, 1);
