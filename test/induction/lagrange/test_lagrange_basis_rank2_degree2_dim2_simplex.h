...
namespace po_test
{
  namespace rank2_degree2_dim2_lagrange_simplex_basis
  {
  ...
  void test_lagrange_basis_rank2_degree2_dim2_simplex()
  {
    using namespace rank2_degree2_dim2_lagrange_simplex_basis;
