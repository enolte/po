...
namespace po_test
{
  namespace rank3_degree2_dim2_lagrange_simplex_basis
  {
  ...
  void test_lagrange_basis_rank3_degree2_dim2_simplex()
  {
    using namespace rank3_degree2_dim2_lagrange_simplex_basis;
