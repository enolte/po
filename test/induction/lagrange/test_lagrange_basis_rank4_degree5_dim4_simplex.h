...
namespace po_test
{
  namespace rank4_degree5_dim4_lagrange_simplex_basis
  {
  ...
  void test_lagrange_basis_rank4_degree5_dim4_simplex()
  {
    using namespace rank4_degree5_dim4_lagrange_simplex_basis;
  ...
  namespace rank4_degree5_dim4_lagrange_simplex_basis
  {
    ...
    void test(const double vertices[][rank], int k)
    {
      ...
      static constexpr double tol = 0x1p-08;
