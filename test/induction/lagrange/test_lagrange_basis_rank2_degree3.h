...
namespace po_test
{
  namespace rank2_degree3_lagrange_basis
  {
  ...
  void test_lagrange_basis_rank2_degree3()
  {
    using namespace rank2_degree3_lagrange_basis;
  ...
  namespace rank2_degree3_lagrange_basis
  {
    ...
    static constexpr double points[][10][2]
    {
      {
        {0, 0},
        {0, 0.5},
    ...
    void test(const double points[10][2], int = -1);
    ...
    void test(const double points[10][2], int k)
    {
      ...
      static constexpr double tol = 0x1.fp-44;
