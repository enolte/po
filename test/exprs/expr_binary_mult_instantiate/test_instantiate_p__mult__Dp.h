...
void test_instantiate_p__mult__Dp(const po::polynomial& p, const po::polynomial& q, po::polynomial ex);

void test_instantiate_p__mult__Dp()
{
  {
    ...
    test_instantiate_p__mult__Dp<po::rank<2>>(
      p, q,
      {
        {0, {0, 0}},
      });
